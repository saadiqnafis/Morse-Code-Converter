...
## Constraints file for the top level
##--------------------------------------------------------------------------------
...
## LEDs
set_property PACKAGE_PIN U16 [get_ports MorseOut]					
	set_property IOSTANDARD LVCMOS33 [get_ports MorseOut]
...
##Pmod Header JA
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports soundOut]					
